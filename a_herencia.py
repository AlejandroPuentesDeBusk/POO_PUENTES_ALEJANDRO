...
class Collar:
    ...
    def describir(self):
        print("Este es un collar de color",
...
class PerroDeServicio(Perro):
    ...
    def trabajar(self):
        print(self.nombre, "está trabajando como perro de servicio siendo",
            self.tipo_servicio)
...
#CLASE COLLAR
collar1 = Collar("rojo", "nylon")
collar2 = Collar("plateado", "acero")

#CLASE PERRO_SERVICIO
perro_servicio = PerroDeServicio("Hitler", "Labrador", 5, "guia")
